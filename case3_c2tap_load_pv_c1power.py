...
data = pd.read_excel('case5_c2tap_load_pv_c1power.xlsx')
model = MultiOutputRegressor(LinearRegression())
temp = 8000
X_train = data.iloc[:temp, 6:].copy()
Y_train = data.iloc[:temp, :6].copy()
X_test = data.iloc[temp:, 6:]
Y_test = data.iloc[temp:,:6]
